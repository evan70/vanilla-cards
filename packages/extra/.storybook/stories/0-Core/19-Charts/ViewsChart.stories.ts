 ...
 */
const meta = {
  title: '0-Core/19-Charts/ViewsChart',
  tags: ['autodocs'],
  render: (args) => {
    const container = document.createElement('div');
    container.className = 'views-chart-card';
    container.style.cssText = 'background: linear-gradient(180deg, rgba(255,255,255,0.08), rgba(255,255,255,0.03)); border: 1px solid rgba(255,255,255,0.1); border-radius: 16px; padding: 24px; max-width: 800px; margin: 0 auto;';
