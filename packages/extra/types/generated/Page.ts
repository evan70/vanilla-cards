...
export function isPage(data: unknown): data is Page {
  return (
    ...
    typeof (data as Page).slug === 'string' &&
    typeof (data as Page).content === 'string' &&
    typeof (data as Page).template === 'string' &&
    ((data as Page).metaTitle === undefined || (data as Page).metaTitle === null || typeof (data as Page).metaTitle === 'string') &&
    ((data as Page).metaDescription === undefined || (data as Page).metaDescription === null || typeof (data as Page).metaDescription === 'string') &&
