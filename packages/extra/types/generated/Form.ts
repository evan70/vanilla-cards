...
export function isForm(data: unknown): data is Form {
  return (
    ...
    Array.isArray((data as Form).schema) &&
    ((data as Form).emailNotification === undefined || (data as Form).emailNotification === null || typeof (data as Form).emailNotification === 'string') &&
