...
export function isMedia(data: unknown): data is Media {
  return (
    ...
    ((data as Media).userId === undefined || (data as Media).userId === null || typeof (data as Media).userId === 'string') &&
    ...
    ((data as Media).hash === undefined || (data as Media).hash === null || typeof (data as Media).hash === 'string') &&
